...
ifneq ($(filter 8.0.0,$(PLATFORM_VERSION)),)
PRDOUCT_PACKAGES += \
...
# Interface Manifest
PRODUCT_COPY_FILES += \
    $(HARDWARE_TI_OMAP4_BASE)/manifest.xml:sytem/vendor/manifest.xml

PRODUCT_COPY_FILES += \
    $(HARDWARE_TI_OMAP4_BASE)/seccomp/mediacodec-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy
endif
