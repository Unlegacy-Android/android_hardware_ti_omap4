...
include $(CLEAR_VARS)
BV_CPUVERSION :=$(shell ls $(LOCAL_PATH)/lib/android/libbltsville_*.*.so|\
             sed 's/hardware\/ti\/omap4-next\/bltsville\/ticpu\/lib\/android\/libbltsville_ticpu.//')
...
$(SYMLINKS): $(LOCAL_INSTALLED_MODULE) $(LOCAL_PATH)/Android.mk
	...
	@cp -afr $(LOCAL_PATH)/lib/android/libbltsville_ticpu_license.txt $(TARGET_OUT_VENDOR)/lib
