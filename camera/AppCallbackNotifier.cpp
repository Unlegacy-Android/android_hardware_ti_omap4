...
status_t AppCallbackNotifier::releaseRecordingFrame(const void* mem)
{
    ...
    if(mUseMetaDataBufferMode)
        ...
        /* Stock N releases do not free metadata buffers, but a patch to fw/av
         * can resolve this. Considering this wasn't the HAL's responsibility
         * in previous releases it is recommended to use the fw/av patch
         * instead of this, but the code is left for reference. */
